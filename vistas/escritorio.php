<?php
  ...
  if (isset($_SESSION["user_nombre"]) && $_SESSION["nivel_autoridad"] == "Nivel_1"){
                              ...
                              <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                  <div>
                                    ...
                                    <span class="d-block fs-12 text-fixed-white"><span class="op-7">You have completed</span>
                                      <span class="fw-semibold text-warning">48%</span> <span class="op-7">of the given target,
                                  ...
                                  <ul class="list-unstyled mb-0 crm-recent-activity">
                                      ...
                                      <div class="d-flex align-items-top">
                                        ...
                                        <div class="crm-timeline-content">
                                          <span class="fw-semibold">Update of calendar events &amp;</span><span><a
                                              href="javascript:void(0);" class="text-primary fw-semibold"> Added new events in
                                              next week.</a></span>
                                        </div>
                                    ...
                                    <li class="crm-recent-activity-content">
                                      <div class="d-flex align-items-top">
                                        ...
                                        <div class="crm-timeline-content">
                                          <span>New member <span class="badge bg-pink-transparent">@andreas gurrero</span> added
                                            today to AI Summit.</span>
                                        </div>
                                        <div class="flex-fill text-end">
                                    ...
                                    <li class="crm-recent-activity-content">
                                      <div class="d-flex align-items-top">
                                        ...
                                        <div class="crm-timeline-content">
                                          <span>Neon Tarly added <span class="text-info fw-semibold">Robert Bright</span> to AI
                                            summit project.</span>
                                        </div>
                                        <div class="flex-fill text-end">
    ...
    <?php
  }else if (isset($_SESSION["user_nombre"]) && $_SESSION["nivel_autoridad"] == "Nivel_2"){
    ?>
      <!DOCTYPE html>
      <html lang="es" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="icon-overlay-close">
          ...
          <div class="page">
            ...
            <div class="main-content app-content">
              <div class="container-fluid">
                ...
                <!-- DATOS PRINCIPALES DEL ESCRITORIO DEL COORDINADOR -->
    ...
    <?php
  } else if (isset($_SESSION["user_nombre"]) && $_SESSION["nivel_autoridad"] == "Nivel_3"){ 
    ?>
      <!DOCTYPE html>
      <html lang="es" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="icon-overlay-close">
          ...
          <div class="page">
            ...
            <div class="main-content app-content">
              <div class="container-fluid">
                ...
                <!-- DATOS PRINCIPALES DEL ESCRITORIO DEL DOCENTE -->
    ...
    <?php
  } else if (isset($_SESSION["user_nombre"]) && $_SESSION["nivel_autoridad"] == "Nivel_4"){
    ?>
      <!DOCTYPE html>
      <html lang="es" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="icon-overlay-close">
          ...
          <div class="page">
            ...
            <div class="main-content app-content">
              <div class="container-fluid">
                ...
                <!-- DATOS PRINCIPALES DEL ESCRITORIO DEL ESTUDIANTE -->

                                ...
                                <div class="row gy-2" id="cargando-3-fomulario">  
                                  ...
                                  <div class="col-xl-12 mb-4">                        
                                    <div class="mail-notification-settings">
                                      <p class="fs-14 mb-1 fw-semibold text-primary">Gestión de Empresa (Nivel 1)</p>
                                      <p class="fs-12 mb-0 text-muted">Escoje los módulos correspondientes al menú</p>
                                    </div>                        
                                    <div  id="permisos_empresa"> </div>
                                  </div>   

                                  <div class="col-xl-12 mb-4">                        
                                    <div class="mail-notification-settings">
                                      <p class="fs-14 mb-1 fw-semibold text-primary">Gestión de Coordinador (Nivel 2)</p>
                                      <p class="fs-12 mb-0 text-muted">Asigna al usuario a la empresa correcta</p>
                                    </div>                        
                                    <div id="permisos_coordinador"> </div>                                           
                                  </div>

                                  <div class="col-xl-12">                        
                                    <div class="mail-notification-settings">
                                      <p class="fs-14 mb-1 fw-semibold text-primary">Gestión del Docente (Nivel 3)</p>
                                      <p class="fs-12 mb-0 text-muted">Asigna al usuario a la empresa correcta</p>
                                    </div>                        
                                    <div id="permisos_docente"> </div>                                           
                                  </div>
